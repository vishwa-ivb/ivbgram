...
<body>
	...
	<j:choose>
		...
		<a type="button" class="editbtn" onClick="editprofilepop();"><i class="fas fa-edit" aria-hidden="true"
				...
				<j:otherwise>
				<a class="backbtn" onClick="history.back();"><i class="fa-solid fa-angle-left"></i></a>
				<a type="submit" class="messagebtn" onClick="messagepop();"><i class="fa-regular fa-message"></i></a><br><br>
				</j:otherwise> </j:choose>
		<div class="profile-tab">
			<form action="/message" id="msgpop" method="post">
			<input type="hidden" class="" name="sender" id="sender" value="${currentuser}">
			<div class="propicdiv">
			...
			<input type="hidden" class="form-control" id="receiver" name="receiver" value="${profile.account}" readonly>
				${profile.account}
			</div>
			<div>
				${profile.about}
			...
			<hr>                          
        <div class="posts">
        <h2 id="content-heading">Posts(${profile.postscount})</h2>
