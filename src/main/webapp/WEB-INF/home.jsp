...
<body>
  <div class="usergreeting row">
    <div class="propicdiv col-lg-1">
      <img id="propic" alt="No image available for this Post!" src="/profile/picture/${profile.pid}" onerror="this.src='resources/images/profileicon.png'" />
    </div>
    <div class="col-lg-9" style="padding: 0;display: flex;align-items: center;">
      ...
      <form id="profileform" action="/showprofile" method="post">
        <input type="hidden" class="form-control" id="account" name="account" value="${user}" readonly>
        <input type="hidden" class="form-control" id="currentuser" name="currentuser" value="${user}" readonly>
      </form>
  ...
  <div class="home container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-lg-2 tools">
		...
		<a type="submit" id="message" onClick="messagepop();">Message</a><br><br>
        <a type="submit" id="profile" onClick="myprofile();">Profile</a><br><br>
        <a type="submit" id="notification" onClick="notifications();">Notifications</a><br><br>
                  ...
                  <j:when test="${s.account == user}">
                    <div class="options col-lg-2">
                      ...
                      <form class="commentPostbtn" action="">
                        ...
                        <input type="hidden" class="comment-form-control" id="${s.id}" value="${i}" readonly>
 ...
 --> <a onclick="spop()" type="button" id="searchpopup"><i class="fa-solid fa-magnifying-glass searchicon"></i></a>
        ...
        <br><br><br><br><br><br>
        <img alt="logo" src="resources/images/sharingan.png" style="width: 70px;">
        <h3 style="color:#03e9f4;">&copy; IVB Tech</h3>
      </div>

    </div>
    <div id="modal-noti-background">
      <div id="modal-noti">
        <div class="close-noti">+</div>
        <h3 style="padding-bottom: 20px;">Notifications</h3>
        <%int n=1;%>
        	<j:forEach items="${notifications}" var="n">
        		<j:set var="num" value="<%=n%>"></j:set>
        			
                 <div id="eachcom${num}" onclick="connectnoti(${num})" style="background-color:#f2eee3;border-radius:10px;">    
                 <input id="connectid${num}" value="${n.connectId}" type="hidden">  			
						<div class="row" style="margin-bottom:20px;margin-left: 0px;margin-right: 0px;">
                                <div class="col-lg-6">
                                  <p id="nm${num}">${n.notimsg}</p>
                                </div>
                                <div class="col-lg-6">
                                  ${n.notiDate}
                                </div>
                 ...
                 <script>  
         				if(${n.is_read}==0){
         					document.getElementById("eachcom${num}").style.fontWeight = "bolder";
         					document.getElementById("notification").style.textDecoration = "underline";
       					}
         			</script>
                            <%n++;%>
                          </j:forEach>
...
<!--      <div id="noti-post" style="background-color: rgba(0, 0, 0, 0.8);width: 100%;height: 100%;position: fixed; -->
<!--                      left: 0px; top: 0px;display: none;justify-content: center;  align-items: center;"> -->
<!--                       <div class="row" style="width: 100%"> -->
<!--                         <h3 style="color:white;">Comments</h3> -->
<!--                         <div class="modal-comment-edit col-lg-6"> -->
...
<!--                     </div> -->
	...
	<div id="modal-message-background">
      ...
      <div class="close-chat" onClick="closemsgpop();">+</div>
      <div style="position: fixed;left: 600px;font-size: x-large;font-weight: bold;top: 35px;">Chats</div>
     	<div class="row">
     		<div class="col-lg-4" style="height: auto;margin-top: 30px;background-color: #f2eee3;padding-bottom: 10px;padding-right: 0;padding-left: 0;overflow-x: hidden;">
     			<%int cc=1;%>
        	<j:forEach items="${chats}" var="cc">
        		<j:set var="count" value="<%=cc%>"></j:set>
        			
                 <div id="eachchat${count}" onClick="connectmsgpop(${count})" style="background-color: rgba(0,0,0,.5);">    
<%--                  <input id="connectchatid${count}" value="${cc.connectId}" type="hidden">  			 --%>
						<div class="row" style="margin-bottom: 10px;height: 60px;overflow: hidden;">
                                <div class="col-lg-3">
                                <img style="max-width: 100px;max-height: 100px;padding: 0;clip-path: circle();
                                "alt="No image!" src="/profile/picture/${cc.pid}" 
                                onerror="this.src='resources/images/profileicon.png'" >
                                </div>
                                <div class="col-lg-9"style="text-align: -webkit-center;align-items: center;
                                display: flex;font-size: x-large;font-weight: bolder;color:#03e9f4;">
                                  ${cc.account}
                                  <form id="form${count}" action="/message" method="post">
                                  <input type="hidden" name="sender" value="${user}">
                                  <input type="hidden" name="receiver" value="${cc.account}">
                                  </form>
                                </div>
                              </div>
                            </div>
     		...
     		<div class="col-lg-8" style="height: 480px;margin-top: 30px;"></div>
     	</div>
      </div></div>
