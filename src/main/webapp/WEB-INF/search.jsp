...
<body>
	...
	<a type="submit" class="backbtn" onClick="history.back();"><i class="fa-solid fa-angle-left"></i></a>
	<div class="row" style="align-items: center;text-align: -webkit-center;margin-top: 0;margin-right: 0;margin-left: 0;">
		...
		<div class="col-lg-12">
		<a type="submit" class="toggleposts" onClick="showpostresult();" >Posts</a>
        <a type="submit" class="toggleaccounts" onClick="showaccountresult();">Users</a>
   		<div class="search">
			
        <div class="accountresults" style="display:none;">
            <h2 id="content-heading">Search Results for "${searchkey}" <a style="font-size: 20px;">(${totalpostnum} posts,${totalaccountnum} accounts)</a> </h2>
        	
        	 <div class="everyaccount">
        	 ${noaccountresults}
        	  <%int j=1;%>
        	<j:forEach items="${searchaccountresults}" var="a">
        	<j:set var="j" value="<%=j%>"></j:set>
            <form id="profileform${j}" action="/showotherprofile" method="post">
   					 <input type="hidden" class="form-control" name="account" value="${a.account}" readonly>
   					 <input type="hidden" class="form-control" name="accountnum" value="${j}" readonly>
   					 <input type="hidden" class="form-control" name="currentuser" value="${searchinguser}" readonly>
   				 </form>
                           <div class="eachaccount row" onClick="showprofile(${j});">
	                           <div class="propicdiv col-lg-2">
		                           <img id="propic" alt="No image available for this Post!" 
									src="/profile/picture/${a.pid}" 
									onerror="this.src='resources/images/profileicon.png'" />
								</div>
								<div class="col-lg-10">
									<p class="acc">${a.account}</p>
								</div>
